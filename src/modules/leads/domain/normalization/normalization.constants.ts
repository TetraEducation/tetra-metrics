export const PROFILE_FIELD_TO_QUESTION_KEYS = {
  ...
  powerBiKnowledge: [
    ...
    "powerbi",
    "nivel-power-bi",
    "conhecimento-power-bi",
    "em que nível você acredita estar no Power BI",
  ],
  jobRole: [
    "cargo",
    "funcao",
...
export const COMPANY_SIZE_ALIASES = {
  ...
  unemployed: [
    "nao estou trabalhando no momento",
...
export const POWER_BI_KNOWLEDGE_ALIASES = {
  beginner: ["iniciante", "estou dando os primeiros passos"],
  basic: ["basico", "básico"],
  intermediate: ["intermediario", "intermediário"],
  advanced: ["avancado", "avançado"],
} as const;
